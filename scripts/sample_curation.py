...
category_mapping = {
    ...
    'Forêt fermée à mélange de feuillus': {'Nom': 'Mélange_de_feuillus', 'Code': '15'},
    'Forêt fermée de feuillus purs en îlots': {'Nom': 'Feuillus_en_îlots', 'Code': '16'},
    'Forêt fermée d’un autre conifère pur autre que pin': {'Nom': 'Autres_conifères_autre_que_pin','Code': '21'},
    'Forêt fermée de mélèze pur': {'Nom': 'Autres_conifères_autre_que_pin', 'Code': '21'},
    'Forêt fermée de sapin ou épicéa': {'Nom': 'Autres_conifères_autre_que_pin', 'Code': '21'},
    'Forêt fermée à mélange d’autres conifères': {'Nom': 'Autres_conifères_autre_que_pin', 'Code': '21'},
    ...
    'Forêt fermée à mélange de conifères': {'Nom': 'Mélange_conifères', 'Code': '26'},
    'Forêt fermée de conifères purs en îlots': {'Nom': 'Conifères_en_îlots', 'Code': '27'},
    'Forêt fermée à mélange de conifères prépondérants et feuillus': {'Nom': 'Mélange_de_conifères_prépondérants_et_feuillus', 'Code': '28'},
    'Forêt fermée à mélange de feuillus prépondérants et conifères': {'Nom': 'Mélange_de_feuillus_prépondérants_et_conifères', 'Code': '29'},
}
